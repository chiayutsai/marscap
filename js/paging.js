...
//  }
  ...
  function page_even() {
    ...
    var append_html='<button class="prev_page">Prev</button>';
    ...
    append_html+='<button class="next_page">Next</button><span class="page_total">Totla : '+total_page+'  pages  </span><input class="input_page_num" type="text" value="'+inp_val+'"><button class="to_page_num">Go</button>';
